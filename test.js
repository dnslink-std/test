...
function getResult (options) {
  switch (domain) {
    ...
    case '_dnslink.t03.dnslink.dev':
      return { found: { ipfs: 'EFGH' }, warnings: [{ code: 'RESOLVE', domain: '_dnslink.t03.dnslink.dev' }] }
    ...
    case '_dnslink._dnslink.t04.dnslink.dev':
      return {
        found: {},
        warnings: [{ code: 'RECURSIVE_DNSLINK_PREFIX', domain: '_dnslink._dnslink.t04.dnslink.dev' }]
      }
